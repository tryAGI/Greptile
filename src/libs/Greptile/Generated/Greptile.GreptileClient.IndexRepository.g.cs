...
namespace Greptile
{
    public partial class GreptileClient
    {
        ...
        partial void PrepareIndexRepositoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Greptile.IndexRepositoryRequest request);
        partial void ProcessIndexRepositoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessIndexRepositoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Greptile.IndexRepositoryResponse> IndexRepositoryAsync(

            global::Greptile.IndexRepositoryRequest request,
            global::Greptile.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await IndexRepositoryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Greptile.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Greptile.AutoSDKHttpResponse<global::Greptile.IndexRepositoryResponse>> IndexRepositoryAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareIndexRepositoryArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Greptile.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Greptile.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "IndexRepositoryAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessIndexRepositoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Greptile.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessIndexRepositoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Greptile.IndexRepositoryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Greptile.AutoSDKHttpResponse<global::Greptile.IndexRepositoryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Greptile.IndexRepositoryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await IndexRepositoryAsync(
                request: __request,
                requestOptions: requestOptions,
