...
namespace Greptile
{
    public partial class GreptileClient
    {
        ...
        private static readonly global::Greptile.EndPointSecurityRequirement s_GetRepositoryInfoSecurityRequirement0 =
        ...
        private static readonly global::Greptile.EndPointSecurityRequirement[] s_GetRepositoryInfoSecurityRequirements =
            new global::Greptile.EndPointSecurityRequirement[]
            {                s_GetRepositoryInfoSecurityRequirement0,
            };
        partial void PrepareGetRepositoryInfoArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string repositoryId);
        partial void PrepareGetRepositoryInfoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string repositoryId);
        partial void ProcessGetRepositoryInfoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRepositoryInfoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Greptile.RepositoryInfo> GetRepositoryInfoAsync(
            string repositoryId,
            global::Greptile.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetRepositoryInfoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Greptile.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Greptile.AutoSDKHttpResponse<global::Greptile.RepositoryInfo>> GetRepositoryInfoAsResponseAsync(
            string repositoryId,
            global::Greptile.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRepositoryInfoArguments(
            ...
            var __authorizations = global::Greptile.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetRepositoryInfoSecurityRequirements,
                operationName: "GetRepositoryInfoAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Greptile.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Greptile.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetRepositoryInfoAsync",
                ...
                cancellationToken: __effectiveCancellationToken).ConfigureAwait(false);
                    ...
                    {
                        var __retryDelay = global::Greptile.AutoSDKRequestOptionsSupport.GetRetryDelay(
                            clientOptions: Options,
                            requestOptions: requestOptions,
                            response: null,
                            attempt: __attempt);
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetRepositoryInfoResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Greptile.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Greptile.ErrorResponse? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Greptile.ErrorResponse.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Greptile.ApiException<global::Greptile.ErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetRepositoryInfoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Greptile.RepositoryInfo.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Greptile.AutoSDKHttpResponse<global::Greptile.RepositoryInfo>(
                                        statusCode: __response.StatusCode,
                                        headers: global::Greptile.AutoSDKHttpResponse.CreateHeaders(__response),
                                        requestUri: __response.RequestMessage?.RequestUri,
                                        body: __value);
                                }
                                catch (global::System.Exception __ex)
                                {
                                    throw global::Greptile.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Greptile.RepositoryInfo.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
