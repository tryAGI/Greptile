                    ...
                    await global::Greptile.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Greptile.RepositoryInfo.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Greptile.RepositoryInfo.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
