...
namespace Greptile
{
    public partial class GreptileClient
    {
        ...
        private static readonly global::Greptile.EndPointSecurityRequirement s_QueryCodebaseSecurityRequirement0 =
        ...
        private static readonly global::Greptile.EndPointSecurityRequirement[] s_QueryCodebaseSecurityRequirements =
            new global::Greptile.EndPointSecurityRequirement[]
            {                s_QueryCodebaseSecurityRequirement0,
            };
        partial void PrepareQueryCodebaseArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Greptile.QueryRequest request);
        partial void PrepareQueryCodebaseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Greptile.QueryRequest request);
        partial void ProcessQueryCodebaseResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::Greptile.QueryResponse> QueryCodebaseAsync(

            global::Greptile.QueryRequest request,
            global::Greptile.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await QueryCodebaseAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Greptile.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Greptile.AutoSDKHttpResponse<global::Greptile.QueryResponse>> QueryCodebaseAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Greptile.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueryCodebaseSecurityRequirements,
                operationName: "QueryCodebaseAsync");
                ...
                else
                {
                    await global::Greptile.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueryCodebaseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Greptile.QueryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Greptile.AutoSDKHttpResponse<global::Greptile.QueryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Greptile.QueryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Greptile.QueryResponse> QueryCodebaseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Greptile.QueryRequest
            {
                Messages = messages,
            ...
            return await QueryCodebaseAsync(
                request: __request,
                requestOptions: requestOptions,
