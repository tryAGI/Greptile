...
namespace Greptile
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Greptile.AutoSDKRetryOptions Retry { get; set; } = new global::Greptile.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Greptile.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Greptile.IAutoSDKHook>();
        ...
        public global::Greptile.AutoSDKClientOptions AddHook(
            global::Greptile.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Greptile.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Greptile.AutoSDKClientOptions UseAuthorizationProvider(
            global::Greptile.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Greptile.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Greptile.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Greptile.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Greptile.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Greptile.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Greptile.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Greptile.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Greptile.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Greptile.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Greptile.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Greptile.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Greptile.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Greptile.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Greptile.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Greptile.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Greptile.AutoSDKClientOptions clientOptions,
            global::Greptile.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Greptile.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Greptile.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Greptile.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Greptile.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Greptile.IAutoSDKHook, global::Greptile.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Greptile.AutoSDKHookContext context)
        {
