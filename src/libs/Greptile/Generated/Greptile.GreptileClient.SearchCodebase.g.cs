...
namespace Greptile
{
    public partial class GreptileClient
    {
        ...
        {
            var __response = await SearchCodebaseAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Greptile.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Greptile.AutoSDKHttpResponse<global::Greptile.SearchResponse>> SearchCodebaseAsResponseAsync(
                    ...
                    await global::Greptile.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Greptile.SearchResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Greptile.AutoSDKHttpResponse<global::Greptile.SearchResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Greptile.SearchResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
