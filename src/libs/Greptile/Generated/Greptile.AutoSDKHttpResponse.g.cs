...
namespace Greptile
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Greptile.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Greptile.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Greptile.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Greptile.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Greptile.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Greptile.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Greptile.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Greptile.ApiException exception)
        ...
        private static global::Greptile.AutoSDKRequestOptions CloneRequestOptions(
            global::Greptile.AutoSDKRequestOptions? source)
        {
            var clone = new global::Greptile.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
